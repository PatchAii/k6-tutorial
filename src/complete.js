...
export let options = {
    ...
    thresholds: {
        ...
        "http_req_duration{name: post-form}": ["avg<300"],
...
export default function () {
    ...
    const loginResponse = http.post(`${host}/anything`, JSON.stringify(credentials), {
        headers: {
    ...
    // console.log(JSON.parse(jsonResponse.body)["slideshow"] !== undefined )
    check(jsonResponse, {
